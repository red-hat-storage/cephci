...
class CephVolumeWorkflows:
    ...
    def lvm_zap(self, host, destroy=None, osd_id=None, osd_fsid=None, device=None, logical_volume=None):
        ...
        Example:
            ...
            usage with logical_volume:
                *Note: volume_group has to be passed along with logical_volume in format volume_group/logical_volume.
                volumeobject.lvm_zap(logical_volume="ceph-7fe80d7f-893e-43fa-82e0-29f3bb417c94/osd-block-82474a14-a79a-4288-8727-8def64745c6d", host=osd_host)
        """
    ...
    def lvm_new_db(self, host, osd_id:str, osd_fsid:str,  logical_volume:str ,volume_group:str):
        ...
        Usage:
            volumeobject.lvm_new_db(host=osd_host, osd-id="1", osd-fsid="7ce687d9-07e7-4f8f-a34e-d1b0efb89921, "volumegroup/logicalvolume)
        """
        _cmd = f"ceph-volume lvm new-db --osd-id {osd_id} --osd-fsid {osd_fsid} --target {volume_group}/{logical_volume}"
        return self.run_cv_command(cmd=_cmd, host=host)

    def lvm_new_wal(self, host, osd_id:str, osd_fsid:str,  logical_volume:str ,volume_group:str):
        ...
        Usage:
            volumeobject.lvm_new_wal(host=osd_host, osd-id="1", osd-fsid="7ce687d9-07e7-4f8f-a34e-d1b0efb89921, "volumegroup/logicalvolume)
        """
        _cmd = f"ceph-volume lvm new-wal --osd-id {osd_id} --osd-fsid {osd_fsid} --target {volume_group}/{logical_volume}"
        return self.run_cv_command(cmd=_cmd, host=host)
