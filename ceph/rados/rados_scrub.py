...
class RadosScrubber:
    ...
    def verify_scrub(self,before_scrub_data,after_scrub_data):
        """
          ...
          Return: 0 or 1 
          """
        before_scrub_log = dict(zip(before_scrub_data['pgid'],before_scrub_data['last_scrub_stamp'] ))
        after_scrub_log = dict(zip(after_scrub_data['pgid'],after_scrub_data['last_scrub_stamp'] ))
