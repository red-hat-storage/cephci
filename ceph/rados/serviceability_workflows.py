...
class ServiceabilityMethods:
    ...
    def remove_offline_host(self, host_node_name: str):
        ...
        try:
            ...
            if not self.rados_obj.check_host_status(hostname=rm_host.hostname):
                err_msg = (
            ...
            log.info(f"Removing offline host {rm_host.hostname} from the cluster")
        ...
        #         log.error(rm_host.hostname + " is still part of the cluster")
    ...
    def drain_host(self, host_obj, zap=True, keep_conf=False):
        ...
        cmd = "ceph orch host drain %s --force" % host_obj.hostname
