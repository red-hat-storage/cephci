...
class CephNode(object):
    ...
    def setup_rhceph_cdn_repos(self, build, distro_ver):
        ...
        repos_5x_rhel9 = ["rhceph-5-tools-for-rhel-9-x86_64-rpms"]
        ...
        elif build.startswith("5") & distro_ver.startswith("8"):
            repos = repos_5x_rhel8
        elif build.startswith("5") & distro_ver.startswith("9"):
            repos = repos_5x_rhel9
        self.exec_command(
