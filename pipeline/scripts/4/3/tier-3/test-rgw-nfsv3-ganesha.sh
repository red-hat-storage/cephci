#! /bin/sh
echo "Begin testing of RGW NFSv3 Ganesha 4.x testing."

random_string=$(cat /dev/urandom | tr -cd 'a-z0-9' | head -c 5)
instance_name="ci-${random_string}"
platform="rhel-8"
rhbuild="4.3"
test_suite="suites/nautilus/rgw/tier-3_rgw_ganesha.yaml"
test_conf="conf/nautilus/rgw/tier-2_rgw_ganesha.yaml"
