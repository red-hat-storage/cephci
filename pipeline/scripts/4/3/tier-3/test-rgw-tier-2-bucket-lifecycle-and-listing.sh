#! /bin/sh
echo "Beginning Ceph RGW Bucket lifecycle and listing functionality testing."

random_string=$(cat /dev/urandom | tr -cd 'a-z0-9' | head -c 5)
instance_name="ci-${random_string}"
platform="rhel-7"
rhbuild="4.3"
test_suite="suites/nautilus/rgw/tier-2_rgw_image_test-bucket-lifecycle-and-listing.yaml"
