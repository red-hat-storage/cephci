...
from utility.utils import setup_cluster_access, configure_ha_proxy
import sys
...
def run(ceph_cluster, **kw):
    ...
    number_of_nodes = ceph_cluster.get_ceph_objects("rgw")
    if len(number_of_nodes) > 1:
        first_rgw_ceph_object = ceph_cluster.get_ceph_object("rgw")
        configure_ha_proxy(first_rgw_ceph_object, number_of_nodes)
