...
def run(ceph_cluster, **kw):
    ...
    host_list_out = cephadm.ceph.orch.host.ls(format="json")
    ...
    cmd = f"cephadm shell ceph cephadm prepare-host-and-enable-sudo-hardening {user}"
    out, err = installer.exec_command(cmd=cmd, sudo=True, long_running=False)
