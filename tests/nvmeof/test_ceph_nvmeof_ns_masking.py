...
def run(ceph_cluster: Ceph, **kwargs) -> int:
    ...
    try:
        ...
        try:
            if ns_masking.executor and ns_masking.io_tasks:
                LOG.info("Waiting for completion of IOs.")
                ns_masking.executor.shutdown(wait=True, cancel_futures=True)
        except NameError:
            LOG.info("NamespaceMasking not initialized, skipping IO shutdown.")
