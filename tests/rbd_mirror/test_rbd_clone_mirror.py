...
def run(**kw):
    ...
    try:
        ...
        if not rbd.create_pool(poolname=poolname):
            ...
            return 1
        rbd.create_image(pool_name=poolname, image_name=imagename, size=size)
        ...
        rbd.create_clone(snap_name, poolname, clone1)
        ...
        mirror1.enable_mirror_image(poolname=poolname, imagename=clone1, mode="journal")
