    ...
    **kw,
    ...
    for pool_type in pool_types:
        ...
        for pool, pool_config in multi_pool_config.items():
            ...
            # Create group
            if scale_option == "test_1_group_50_images":
                no_of_group = 1
                no_of_images_in_each_group = 50
            elif scale_option == "test_100_groups_100_images":
                no_of_group = 100
                no_of_images_in_each_group = 1
            elif scale_option == "test_20_groups_5_images":
                no_of_group = 20
                no_of_images_in_each_group = 5
            elif scale_option == "test_5_groups_20_images":
                no_of_group = 5
                no_of_images_in_each_group = 20
            ...
            if (
                ...
                != group_config["group-spec"].split("/")[-1]
