...
Step 6: Add data to the images using rbd bench or FIO
Step 7: Calculate MD5sum of all files
Step 8: Create Consistency group
Step 9: Enable journal based mirroring on images
Step 10: Add Images in the consistency group
Step 11: Disable mirroring on images
Step 12: Add images in the consistency group
Step 13: Enable journal mirror mode on image1, Should fail
Step 14: Add image from different pool in the same group, Should FAIL
Step 15: Repeat above on EC pool
Step 16: Cleanup the images, file and pools
"""
    ...
    **kw,
    ...
    for pool_type in pool_types:
        ...
        for pool, pool_config in multi_pool_config.items():
            ...
            # Add image from second pool to the group, should FAIL
            group_image_kw = {
                "group-spec": group_config["group-spec"],
                "image-spec": pool_spec + "/" + image_name_second_pool,
            }
