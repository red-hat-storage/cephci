...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if config.get("zap_with_destroy_flag") or config.get(
            ...
            options_list = [["device"], ["osd_id"], ["osd_id", "osd_fsid"]]
            ...
            for option in options_list:
                ...
                osd_lv_name = volumeobject_obj.get_osd_lvm_resource_name(
                    osd_host=osd_host, osd_id=osd_id, resource="lv"
                )
                osd_vg_name = volumeobject_obj.get_osd_lvm_resource_name(
                ...
                if volumeobject_obj.osd_id_or_device_exists_in_lvm_list(
                    osd_host=osd_host,
                    osd_id=osd_id,
                ...
                if config.get("zap_without_destroy_flag"):
                    ...
                    if volumeobject_obj.filesystem_exists_in_logical_volume(
                        osd_host=osd_host,
                        osd_id=osd_id,
