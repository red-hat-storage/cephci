...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if "scenario12" in scenarios_to_run:
            log.info(test_seprator)
            revert_stretch_mode_scenarios.scenario12()
            log.info(test_seprator)
...
class RevertStretchModeScenarios(RevertStretchModeFunctionalities):
    ...
    def scenario12(self):
        """
        Scenario 12:- Negative test: Revert stretch mode when cluster is in recovery
        Steps:-
            1) Check stretch mode is enabled
            2) Create a pool and write IO
    ...
    def scenario13(self):
        """
        Scenario 13:- Negative test: Execute disable_stretch_mode when not in stretch mode
        Steps:-
            1) Check stretch mode is enabled
            2) Disable stretch mode
    ...
    def scenario14(self):
        """
        Scenario 14:- Negative test: Incorrect command usage for disabling stretch mode commands
        Steps:-
            1) Check stretch mode is enabled
    ...
    def scenario15(self):
        """
        Scenario 15:- Negative test: Disable stretch mode without --yes-i-really-mean-it
        Steps:-
            1) Check stretch mode is enabled
    ...
    def scenario16(self):
        """
        Scenario 16:- Negative test: Revert stretch mode by passing non-existing crush rule
        Steps:-
            1) Check stretch mode is enabled
