...
class RevertStretchModeScenarios(RevertStretchModeFunctionalities):
    ...
    def scenario7(self, crush_rule):
        """
        Scenario 7:- Revert stretch mode 1 mon daemon in DC1 Host1 is down
        Steps:-
            1) Shutdown 1 mon daemon in DC1 Host1
    ...
    def scenario8(self, crush_rule):
        """
        Scenario 8:- Revert stretch mode during 1 mon daemon in DC1 Host1 and 1 mon daemon in DC2 Host1 failure
        Steps:-
    ...
    def scenario9(self, crush_rule):
        """
        Scenario 9:- Revert stretch mode during tiebreaker mon daemon failure
        Steps:-
    ...
    def scenario10(self, crush_rule):
        """
        Scenario 10:- Revert stretch mode during all mon daemons in DC1 failure
        Steps:-
            1) Shutdown all mon daemons in DC1 using systemctl
            2) Check stretch mode is enabled
            3) Create a pool and write IO
            4) Revert from healthy stretch mode
            5) Validate all pools are reverted to default rules
