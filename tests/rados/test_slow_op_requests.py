...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        _pool_name = config.get("pool_name", "slow-op-pool")
        ...
        while datetime.datetime.now() < endtime:
            ...
            if slow_ops_msg:
                ...
                log.info("Slow Ops daemons: ", daemon_list)
        ...
        log.info("Slow Ops request frequency: ", slow_ops_frequency)
        max_osd = max(slow_ops_frequency)
        log.info("OSD with highest count of Slow Ops: ", max_osd)
        ...
        for line in init_logs.splitlines():
            if "slow ops" in line:
                ...
                log.info("Slow Ops count: ", count.group(1))
