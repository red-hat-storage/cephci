...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if (
            ...
            log.error(
                "After setting the Threshold to default value(10.0) the scrub operation is not initiated"
            )
            return 1
        after_tst_scrub_err_count = get_pg_inconsistent_object_count(
            rados_object, pg_id
...
def create_inconsistent_objects(rados_object, pool_obj, pool_name):
    """
