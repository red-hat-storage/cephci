...
def run(ceph_cluster, **kw):
    ...
    # Get smb share name
    smb_share_name = config.get(
        "smb_share_name",
        "x9fL2qvB7eT1mZpK4sW8dJxYcV0aR3nGhU6oMbEiTqNzL5wCyHdKvAjXsQbRtFg",
    )
    ...
    try:
        ...
        smb_share_name = (
            "\\" + smb_share_name if smb_share_name.startswith("_") else smb_share_name
        )
        smb_shares = [smb_share_name]
        smbclient_check_shares(
            smb_nodes,
            client,
            smb_shares,
