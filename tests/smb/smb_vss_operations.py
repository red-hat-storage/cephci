...
def run(ceph_cluster, **kw):
    ...
    vss_operations = config.get("vss_operations")
    ...
    try:
        ...
        for operation in vss_operations:
            # Check .snap Directory
            if operation == "Verify .snap":
            ...
            # Verify snapshot creation
                ...
                _, err = client.exec_command(sudo=True, cmd=cmd1)
                if err:
            ...
            elif operation == "Verify snapshot file":
