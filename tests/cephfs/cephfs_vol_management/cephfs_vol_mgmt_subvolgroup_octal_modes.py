...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        run_ios(clients[0], kernel_mounting_dir_2)
        run_ios(clients[0], fuse_mounting_dir_2)
        run_ios(clients[1], kernel_mounting_dir_3)
        run_ios(clients[1], fuse_mounting_dir_3)
        ...
        fs_util.client_clean_up(
            "umount", fuse_clients=[clients[1]], mounting_dir=fuse_mounting_dir_3
        )
