...
def run(ceph_cluster, **kw):
    ...
    2. Try to create a subvolume on the subvolume_group name
    3. If the creation fails, memo it
    4. Try to delete a subvolume on the subvolume_group name
    5. If the deletion fails, memo it.
    6. If the creation and deletion are failed, return 0
    """
    try:
