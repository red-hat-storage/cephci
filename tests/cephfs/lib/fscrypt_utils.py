        ...
        for i in range(0, len(line_list)):
            if i == 0:
                ...
                if found == len(line_list[0]):
                    ...
                    log.info("File permissions could be encrypted:%s", line_list[0])
                    test_status += 1
            elif i in [1, 4, 6]:
                ...
                if res:
                    ...
                    log.info("%s info could be encrypted:%s", info[i], line_list[i])
                    test_status += 1
            elif i in [2, 3]:
                ...
                if line_list[i] in user_list:
                    ...
                    log.info("User info could be encrypted:%s", line_list[i])
                    test_status += 1
            elif i == 5:
                pattern = [
                    "Jan",
                ...
                if line_list[i] in pattern:
                    ...
                    log.info("Month info could be encrypted:%s", line_list[i])
                    test_status += 1
            elif i == 7:
                ...
                if res:
                    ...
                    log.info("Time info could be encrypted:%s", line_list[i])
                    test_status += 1
