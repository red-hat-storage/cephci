...
Acceptance TCs (primary):
  acceptance1_quarantine_flag   — enable succeeds; ls lists name; info minimal quarantine status
...
def subtest_acceptance1_quarantine_flag(qtn, admin, fuse_client, vol_name, config):
    ...
    Expected:
      ...
      - subvolume info succeeds with minimal quarantine status (no path/size)
    """
