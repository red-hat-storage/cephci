...
def run(ceph_cluster, **kw):
    """
    CEPH-83575340 - Convert a standalone CephFS Mirroring service to HA and
    validate all the existing paths part of mirroring are intact and continues to sync post convertion to HA service
    ...
    try:
        ...
        snapshots_to_delete = [
            f"{kernel_mounting_dir_1}{subvol1_path}.snap/snap_k1_single_service*",
            f"{kernel_mounting_dir_1}{subvol1_path}.snap/snap_k1_ha_service_*",
            f"{fuse_mounting_dir_1}{subvol2_path}.snap/snap_f1_single_service*",
            f"{fuse_mounting_dir_1}{subvol2_path}.snap/snap_f1_ha_service_*",
        ]
