...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        log_dir = os.path.join(log_base_dir, "MixedFileSyncPerf_Results")
        ...
        for thread_count in thread_counts:
            ...
            # Check NFS mount liveness before mkdir to avoid a 486s hang
            # on a stale hard-mount (confirmed failure mode from CI run FFDZOP).
