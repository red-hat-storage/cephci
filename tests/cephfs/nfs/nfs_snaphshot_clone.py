...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        commands = [
            f"ceph fs subvolumegroup create {fs_name} subvolume_group1",
            f"ceph fs subvolume create {fs_name} subvolume1 --group_name subvolume_group1",
            f"ceph fs subvolume create {fs_name} subvolume2",
