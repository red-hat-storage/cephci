...
9.  Execute prepare migration with import-only option with --source-spec-path for both parent and child RBD images
...
14. Decrypt both images using the respective keys (LUKS1 for the parent, LUKS2 for the child)
...
def format_image(rbd, c1_client, encryption_type, image_spec):
    ...
    if err:
        ...
        log.info(
            "Successfully formatted the parent image "
            + image_spec
