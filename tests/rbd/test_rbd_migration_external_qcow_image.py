...
8. Note down md5sum checksum of qcow2 formatted data
9. Create a qcow source spec file for migration
10. Execute prepare migration with import-only option with
...
13. Export the migrated image using rbd export command and
note down it's md5sum checksum
14. Verify md5sum checksum of before migration and after
migration should be same
15. Repeat the above test for EC pool
