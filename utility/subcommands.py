...
def save_to_json(command, output, complete_url, remote_base_dir, subcomponent_filter):
    ...
    if "jenkins" in current_dir:
        ...
        openstack_version = url_parts[5]  # RH
        rhel_version = url_parts[6]  # 8.0
        ceph_version = url_parts[8]  # 19.2.0-73
        subfolder = url_parts[7]  # Test
        ...
        local_dir = "/Users/suriya/Desktop/subcommandsoutput/output20"
