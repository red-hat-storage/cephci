...
RH_IT_ROOT_CA_CERT = inspect.cleandoc(
    """
...
#: context using both the OS CA trust store and RH CA certs
SSL_CONTEXT = ssl.create_default_context()
SSL_CONTEXT.load_verify_locations(cadata=RH_IT_ROOT_CA_CERT)
