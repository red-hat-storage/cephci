...
class Image_meta(Cli):
    """
    This module provides CLI interface to manage image metadata for images in pool.
    """

    def __init__(self, nodes, base_cmd):
        super(Image_meta, self).__init__(nodes)
        self.base_cmd = base_cmd + " image-meta"

    def get(self, **kw):
        """
        Get image metadata value for given key.
        Args:
    ...
    def remove(self, **kw):
        """
        Remove image metadata value for given key.
        Args:
            kw(dict): Key/value pairs that needs to be provided to the installer
                Example::
                Supported keys:
    ...
    def set(self, **kw):
        """
        Set image metadata value for given key.
        Args:
            kw(dict): Key/value pairs that needs to be provided to the installer
                Example::
                Supported keys:
