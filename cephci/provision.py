...
def provision(**args):
    ...
    for cluster in cluster_conf.get("globals"):
        ...
        for node in ceph_vmnodes.values():
            ...
            if cloud == "openstack":
                private_ip = _cloud.private_ips()  # _cloud.get_node_private_ips(node), correct?
            elif "baremetal" in cloud:
